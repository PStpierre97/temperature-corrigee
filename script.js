document.getElementById('tacForm').addEventListener('submit', function(e) {
    ...
    const humidity = parseFloat(document.getElementById('humidity').value); // ✅ modifié ici
    ...
    const humiditeCorrections = {
        20: -2.0, 25: -1.0, 30: 0.0, 35: 0.9, 40: 1.8, 45: 2.7,
        50: 3.5, 55: 4.3, 60: 5.0, 65: 5.7, 70: 6.4, 75: 7.1,
        80: 7.7, 85: 8.3, 90: 8.9
    };
    ...
    resultat.innerHTML = `
        🌡️ Température de l’air corrigée : ${tac.toFixed(1)} °C\n
        📊 ${zone}\n
